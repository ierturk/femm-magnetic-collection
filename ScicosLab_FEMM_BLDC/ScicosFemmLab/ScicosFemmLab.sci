...
warning('off');
ScicosFemmLab_path=get_absolute_file_path('ScicosFemmLab.sci');

function openfemm()
    link(ScicosFemmLab_path + "ScicosFemmLab.dll",..
          ["openfemm","call2femm","closefemm"],"c");

    a = fort("openfemm",..
              strcat(emptystr(81,1),char(10)),1,"c",..
              "out",[80,1],1,"c");
              
    a = part(a,[1:strindex(a,char(0))-1]);
...
function z=callfemm(x)
    u=fort("call2femm",..
            strcat(x),1,"c",..
            strcat(emptystr(513,1),char(10)),2,"c",..
            "out",[512,1],2,"c");

    u = part(u,[1:strindex(u,char(0))-1]);
...
function ci_deleteselectedarcsegm()
callfemm('ci_deleteselectedarcsegm'+'ents()');
...
function ci_deleteselectedsegment()
callfemm('ci_deleteselectedsegment'+'s()');
...
function z=co_getconductorprop(pname)
z=callfemm(['co_getconductorprop'+'erties(' , quote(pname) , ')' ]);
...
function ei_deleteselectedarcsegm()
callfemm('ei_deleteselectedarcsegm'+'ents()');
...
function ei_deleteselectedsegm()
callfemm('ei_deleteselectedsegm'+'ents()');
...
function z=eo_getconductorprop(pname)
z=callfemm(['eo_getconductorprop'+'erties(' , quote(pname) , ')' ]);
...
function hi_deleteselectedarcsegm()
callfemm('hi_deleteselectedarcsegm'+'ents()');
...
function hi_deleteselectedsegm()
callfemm('hi_deleteselectedsegm'+'ents()');
...
function z=ho_getconductorprop(pname)
z=callfemm(['ho_getconductorprop'+'erties(' , quote(pname) , ')' ]);
...
function mi_deleteselectedarcsegm()
callfemm(['mi_deleteselectedarcsegm'+'ents()']);
...
function mi_deleteselectedsegm()
callfemm(['mi_deleteselectedsegm'+'ents()']);
